...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="price">$<?= htmlspecialchars($fetch_wishlist['price']); ?>/-</div>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 0)?'':'disabled'; ?>" onclick="return confirm('delete all items from wishlist?');">delete all</a>
   </div>
